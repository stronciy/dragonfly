...
function getClientIdentifier(req) {
    ...
    if (forwarded) {
        ...
        return (_b = (_a = ips[0]) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : "unknown";
    }
    return (_c = req.headers.get("x-real-ip")) !== null && _c !== void 0 ? _c : "unknown";
}
...
async function checkRateLimit(key, windowSeconds = DEFAULT_WINDOW_SECONDS, maxRequests = DEFAULT_MAX_REQUESTS) {
    ...
    const count = (_b = (_a = results === null || results === void 0 ? void 0 : results[2]) === null || _a === void 0 ? void 0 : _a[1]) !== null && _b !== void 0 ? _b : 0;
    const remaining = Math.max(0, maxRequests - count);
    const resetAt = now + windowMs;
    if (count >= maxRequests) {
        const oldestMember = await redis.zrange(key, 0, 0);
        const oldestTimestamp = (oldestMember === null || oldestMember === void 0 ? void 0 : oldestMember[0]) ? parseFloat(oldestMember[0].split("-")[0]) : now;
...
async function retryAfterMiddleware(req, next) {
    ...
    if (!rateLimitResult.allowed) {
        ...
        headers.set("retry-after", String((_a = rateLimitResult.retryAfter) !== null && _a !== void 0 ? _a : DEFAULT_RETRY_AFTER_SECONDS));
